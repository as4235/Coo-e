...
export default withApiAuthRequired(async (req, res) => {
  try {
    ...
    const users = await db.select("users.id", "users.firstname", "users.lastname", "users.name", "users.username", "contact_mechanism.value", "users.avatar", "user_type.value as usertype")
      .from("users")
